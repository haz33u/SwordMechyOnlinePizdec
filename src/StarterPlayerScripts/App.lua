...
function App.Start()
	...
	step("WorldChestService", function()
		local WorldChestService = require(script.Parent.WorldChestService)
		WorldChestService.Init(store)
	end)
	step("LocationDoorService", function()
		local LocationDoorService = require(script.Parent.LocationDoorService)
		LocationDoorService.Init(store, toastApi)
	end)
	...
	scope:Observer(store.modal):onChange(function()
