...
function Remotes.InitAll()
	...
	Remotes.Event("UnlockTalentNode")
	...
	Remotes.Event("UnequipAura")
	Remotes.Event("UpgradeAura") -- coins → +1 aura level (max AuraConfig.MAX_LEVEL)
	Remotes.Event("EquipRelic")
	Remotes.Event("UnequipRelic")
	Remotes.Event("UpgradeRelic") -- stars via merge cost
	Remotes.Event("ClaimQuest")
	Remotes.Event("SetLocation")
	Remotes.Event("StartDungeon")
	Remotes.Event("ExitDungeon")
	Remotes.Event("UsePotion")
	Remotes.Event("ClaimBPReward")
	Remotes.Event("TransferEnchant")
