...
local WorldConfig = {
	...
	Locations = {
		...
		},
		{
			...
			status = "ready",
			blurb = "R2 + 500K once. Crystal mining caverns.",
		},
		{
			id = 3,
			name = "Desert Outpost",
			...
			status = "ready",
			blurb = "R4 + 5M. Sunbaked desert dunes & oases.",
		},
		{
			id = 4,
			name = "Winter Tundra",
			...
			status = "ready",
			blurb = "R6 + 50M. Snowy pines & frozen lakes.",
		},
		{
			id = 5,
			name = "Candy Land",
			...
			coinMult = 40,
			powerMult = 70,
			combatWall = 50_000_000_000,
			status = "ready",
			blurb = "R8 + 500M. Sweet pink lollipops & cupcakes.",
		},
		{
			id = 6,
			name = "Water Haven",
			...
			coinMult = 90,
			powerMult = 150,
			combatWall = 1_200_000_000_000,
			status = "ready",
			blurb = "R10 + 5B. Ocean waters & wooden bridges.",
		},
		{
			id = 7,
			name = "Hell Gate",
			...
			coinMult = 200,
			powerMult = 350,
			combatWall = 30_000_000_000_000,
			status = "ready",
			blurb = "R12 + 50B. Fiery nether pits & dark demon gates.",
		},
		{
			id = 8,
			name = "Storm Spire",
			...
			coinMult = 450,
			powerMult = 800,
			combatWall = 800_000_000_000_000,
			status = "stub",
		...
		},
		{
			...
			coinMult = 1_000,
			powerMult = 1_800,
			combatWall = 20_000_000_000_000_000,
			status = "stub",
		...
		},
		{
			...
			coinMult = 2_200,
			powerMult = 4_000,
			combatWall = 500_000_000_000_000_000,
			status = "stub",
