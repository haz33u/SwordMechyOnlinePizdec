...
local MobConfig = {
	...
	Mobs = {
		...
		L1_Goblin = {
			...
			description = "T1 green smiling goblin. HP 1K / coins 200 / power 5.",
		},
		L1_DarkGoblin = {
			id = "L1_DarkGoblin",
			name = "Dark Goblin",
			...
			description = "T2 dark purple goblin. HP 8K / coins 1.2K / power 25.",
		},
		L1_GoblinWarrior = {
			id = "L1_GoblinWarrior",
			name = "Goblin Warrior",
		...
		L1_GoblinScout = {
			...
			description = "T4 elite goblin scout. HP 150K / coins 18K / power 350.",
		},
