...
local MobConfig = {
	...
	Mobs = {
		...
		L1_Goblin = {
			...
			description = "T1 green smiling goblin. HP 5K / coins 200 / power 5.",
		},
		L1_DarkGoblin = {
			id = "L1_DarkGoblin",
			name = "Dark Goblin",
			...
			description = "T2 dark purple goblin. HP 500K / coins 1.2K / power 25.",
		},
		L1_GoblinWarrior = {
			id = "L1_GoblinWarrior",
			name = "Goblin Warrior",
			...
			description = "T3 heavy armored goblin warrior. HP 2.5M / coins 6K / power 120.",
		},
		L1_GoblinScout = {
			id = "L1_GoblinScout",
			name = "Goblin Scout",
			...
			description = "T4 elite goblin scout. HP 15M / coins 18K / power 350.",
		},
