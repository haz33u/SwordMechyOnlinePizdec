...
local QuestConfig = {
	...
	Quests = {
		...
		Q_Friend_10m = {
			id = "Q_Friend_10m",
			name = "Play with Friend (10m)",
			description = "Play on server with a friend for 10 minutes · reward +10% Power",
			type = "PlayWithFriendMinutes",
			targetId = nil,
			amount = 10,
			rewards = {
				coins = 10000,
		...
		Q_Friend_30m = {
			id = "Q_Friend_30m",
			name = "Play with Friend (30m)",
			description = "Play on server with a friend for 30 minutes · reward +15% Power",
			type = "PlayWithFriendMinutes",
			targetId = nil,
			amount = 30,
			rewards = {
		...
		Q_Friend_60m = {
			id = "Q_Friend_60m",
			name = "Play with Friend (60m)",
			description = "Play on server with a friend for 60 minutes · reward +25% Power & Aura Keys",
			type = "PlayWithFriendMinutes",
			targetId = nil,
			amount = 60,
			rewards = {
		...
		Q_SecondFriend = {
			id = "Q_SecondFriend",
			name = "2 Friends Online",
			description = "Have 2 or more friends online in the server simultaneously · reward +20% Power",
			type = "SecondFriendOnline",
			targetId = nil,
			amount = 1,
			rewards = {
				coins = 50000,
