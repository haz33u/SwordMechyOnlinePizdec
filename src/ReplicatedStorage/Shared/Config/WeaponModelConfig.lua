...
local WeaponModelConfig = {
	...
	ModelByWeaponId = {
		...
		stone_scythe = "StoneScythe",
		stone_spear = "StoneSpear",
		stone_hammer = "StoneHammer",
		iron_sword = "IronSword",
		iron_scythe = "IronScythe",
		iron_spear = "IronSpear",
		iron_hammer = "IronHammer",
		gold_sword = "GoldSword",
		gold_scythe = "GoldScythe",
		gold_spear = "GoldSpear",
		gold_hammer = "GoldHammer",
		titanium_sword = "TitaniumSword",
		titanium_scythe = "TitaniumScythe",
		titanium_spear = "TitaniumSpear",
		titanium_hammer = "TitaniumHammer",
		emerald_sword = "EmeraldSword",
		emerald_scythe = "EmeraldScythe",
		emerald_spear = "EmeraldSpear",
		emerald_hammer = "EmeraldHammer",
		ruby_sword = "RubySword",
		ruby_scythe = "RubyScythe",
		ruby_spear = "RubySpear",
		ruby_hammer = "RubyHammer",
		atherite_sword = "AtheriteSword",
		celestium_sword = "CelestiumSword",
		voidsteel_sword = "VoidsteelSword",
	} :: { [string]: string },
