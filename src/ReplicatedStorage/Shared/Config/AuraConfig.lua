...
local AuraConfig = {
	...
	Auras = {
		...
		--------------------------------------------------------------------------
		-- EXTRACTED EVOLVED / CHARACTER AURAS (place-only, not rollable)
		--------------------------------------------------------------------------
		A_HinataEVO = {
			id = "A_HinataEVO",
			name = "Hinata EVO Aura",
			rarity = "Limited",
			powerPct = 350,
			damagePct = 350,
			coinPct = 200,
		...
		A_CharacterVampire = {
			id = "A_CharacterVampire",
			name = "King of Night Aura",
			rarity = "Secret",
			powerPct = 400,
			damagePct = 400,
			coinPct = 150,
