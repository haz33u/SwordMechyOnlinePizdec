...
add("P1_L1", "Stiko", "Legendary", 1.75, 1, "loc1_500", 2.5085, 500)
...
add("P1_50_L1", "Nightmare", "Legendary", 6, 1, "loc1_50k", 2.004, 5000)
...
add("P1_K_L1", "Heka", "Legendary", 31.9, 1, "loc1_key49", 7.499, 15000)
add("P1_K_L2", "Monster", "Legendary", 50.75, 1, "loc1_key49", 2.5045, 25000)
...
add("P2_L1", "Ceres", "Legendary", 31, 2, "loc2_3_75m", 0.501, 2_000_000)
